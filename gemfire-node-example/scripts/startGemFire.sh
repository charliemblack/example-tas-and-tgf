...
gfsh -e "connect --locator=${LOCATORS}" -e "configure pdx --read-serialized=true --disk-store=DEFAULT"
...
gfsh -e "connect --locator=${LOCATORS}" -e "create region --name=test --type=PARTITION"
